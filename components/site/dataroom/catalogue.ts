...
export const DOCUMENTS: DataDoc[] = [
  /* ---- 01 company & investment ------------------------------------------ */
  {
    ...
    status: 'complete',
    description:
      'The primary institutional investment document for QuFi: six pages covering the investment thesis, the technology and product, uBTC as proof that the model works, the market and business model, the competitive position, and the team and the raise.',
    purpose: 'The first document an investor evaluating QuFi should read.',
    discover: [
      'The instruct → verify → settle model, and where QuFi sits in it',
      'Why a neutral verification layer needs no migration and no new chain',
      'The verification layer architecture, source through to destination',
      'uBTC end to end: deposit, confirm, proof, move, recover',
      'The 0.1% proof-fee model and what it produces at 1%, 5% and 10% penetration',
      'How QuFi compares against blockchains, oracles and ZK systems, line by line',
      'The team, the raise and the use of funds',
    ],
    contents: [
      '01  Investment memo: the moment, the thesis, built for the future',
      '02  The technology and product',
      '03  Proof that the model works: uBTC',
      '04  Market and business model',
      '05  Competitive advantage',
      '06  Team, raise and investment case',
    ],
  ...
  },
  {
    ...
    section: 'company',
    index: '02',
    title: 'QuFi Investor Thesis',
    kind: 'Thesis',
    status: 'complete',
    description:
      'The long form of the case: twelve pages taking the opportunity apart section by section: the technology, the market sizing, the economic model, the security architecture, the go-to-market, the team and the use of funds.',
    purpose:
      'Where the memorandum makes the case in six pages, this one shows the working. Read it second.',
    discover: [
      'The verification layer as a market, sized TAM through SAM to SOM',
      'The product components: verification network, policy engine, proof layer, connectors',
      'The network and economic model, and what makes it compound',
      'The security and post-quantum architecture, lifecycle by lifecycle',
      'uBTC from Bitcoin collateral through to controlled movement and redemption',
      'The go-to-market: entry markets, distribution channels, the commercial flywheel',
      'The raise, the allocation of it, and the case for now',
    ],
    contents: [
      '01  The investment opportunity',
      '02  Technology and product',
      '03  Proof of model',
      '04  Market and business model',
      '05  Competitive advantage',
      '06  Network and economic model',
      '07  uBTC: proof of model',
      '08  Security and post-quantum architecture',
      '09  Go-to-market strategy',
      '10  Team and execution',
      '11  The raise and use of funds',
      '12  Why invest now',
    ],
  ...
  },
  {
    ...
    status: 'complete',
    description:
      'Two pages: what QuFi is, what it is for, and what is being asked for. The shortest complete account of the company in this room.',
    purpose: 'For a reader with five minutes rather than an afternoon.',
    discover: [
      'QuFi in one paragraph, and the four things it deliberately is not',
      'The opportunity stated plainly: the verification rail beneath digital settlement',
      'uBTC as evidence the model runs, across five capabilities',
      'The markets it reaches, from digital asset settlement to cross-chain',
   ...
   */
  {
    ...
    discover: [
      ...
      'Which documents are checked, from bill of lading to inspection to insurance, and against what',
