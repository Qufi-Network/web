...
const marks: Mark[] = [
  { id: 'keys', text: 'Two schemes', at: KEYS, during: [0], lift: 10, x: 0, y: 0, on: 0 },
  { id: 'vault', text: 'The vault', at: VAULT, during: [1, 2, 4, 5], lift: 14, x: 0, y: 0, on: 0 },
  { id: 'immediate', text: 'Immediate', at: IMMEDIATE, during: [2, 3, 4], lift: 7, x: 0, y: 0, on: 0 },
  { id: 'emergency', text: 'Emergency, after a delay', at: EMERGENCY, during: [2, 4], lift: 8, x: 0, y: 0, on: 0 },
  { id: 'recovery', text: 'Recovery, later again', at: RECOVERY, during: [2, 4], lift: 10, x: 0, y: 0, on: 0 },
  { id: 'owner', text: 'The owner', at: OWNER, during: [3, 5], lift: 10, x: 0, y: 0, on: 0 },
  { id: 'chain', text: 'Bitcoin', at: CHAIN, during: [3, 4, 5], lift: -6, x: 0, y: 0, on: 0 },
];
